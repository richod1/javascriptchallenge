...
function rest() {
  document.getElementById('rpsGame(this)').remove();
}
...
function buttonColorChange(buttonThngy){
  if(buttonThngy.value === 'red'){
    buttonRed();
  }else if(buttonThngy.value === 'green'){
    buttonGreen();
  }else if(buttonThngy.value === 'reset'){
    buttonColorReset();
  }else if(buttonThngy.value==='random'){
    randomButton();
  }
}
...
//detremine who wins and who lost
